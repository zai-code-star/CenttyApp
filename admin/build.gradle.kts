...
dependencies {
    ...
    implementation("com.google.android.gms:play-services-location:18.0.0") // Mengirim dan menerima pesan push dengan Firebase Cloud Messaging.
    ...
    annotationProcessor("com.squareup.picasso:picasso:2.71828") // Compiler untuk Glide, digunakan saat menggunakan beberapa fitur khusus Glide.
    ...
    implementation("io.supercharge:shimmerlayout:2.1.0") // Widget layout untuk menyegarkan konten dengan menarik ke bawah.
}
